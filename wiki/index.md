...
- [design/avatar-picker-component](design/avatar-picker-component.md) —— 头像定制器组件化（party-net v1.1）：dicebear-local 抽取契约、dataURL 注入白名单、boot/删除语义与 detached 树构建雷（2026-09-20）
